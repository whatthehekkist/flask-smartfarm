"""
y target = SoilMoistureDegree
(로지스틱회귀 사용: SoilMoisture 값 없는 버젼)
"""
...
def predict_soil_moisture(n_clicks, temp, hum, rain, wind, soil_type):
    ...
    # return f"토양습도 : {'높음' if prediction == 1 else '낮음'}  {closest_soil_moisture}%"
