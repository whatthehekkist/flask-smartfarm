"""
y target = SoilMoisture
(선형회귀 사용: SoilMoisture를 타깃 구한후 SoilMoistureDegree를 다음의 간단한 계산만 하여 설정)

SoilMoisture 변수를 30% 기준으로 이진 분류(0: 낮음, 1: 높음) 하세요.
"""
...
def train_model():
    ...
    y = df['SoilMoisture']  # SoilMoisture를 타겟으로 설정
    ...
    model = Pipeline(steps=[
        ...
        ('regressor', LinearRegression())  # 회귀 모델로 변경
